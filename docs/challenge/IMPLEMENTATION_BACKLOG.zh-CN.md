...
|---|---:|---|---|---|---|
| P0-001 | P0 | TODO | 修复 smoke 初始工具数量假设 | `tools/e2e-webmcp.mjs` | 空页 3 工具，profile 后动态工具出现 |
| P0-002 | P0 | TODO | 统一 compare 参数为 `targetDates` | Bridge、测试、docs、agents | 全仓无错误 `dates` 示例 |
| P0-003 | P0 | TODO | 实现 `inspect_chart.focusIds` | Bridge、workspace、Ziwei | 命宫/身宫真实高亮 |
...
| P0-007 | P0 | TODO | 统一工具 error result | hook、Bridge、tests | 所有失败 `isError: true` |
| P0-008 | P0 | TODO | 主 Demo WebMCP E2E | E2E | create→focus→compare→human→read→undo |
