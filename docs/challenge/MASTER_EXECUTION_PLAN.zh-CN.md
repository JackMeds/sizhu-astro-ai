...
| P0-008 | 主 Demo WebMCP E2E | P0-001～007 | create→focus→compare→human→read→undo |
| P0-009 | 英文主路径残留扫描 | P0-001 | 关键路径没有硬编码中文控件 |
| P0-010 | 国际时区 E2E | P0-001 | DST、半小时与 45 分钟偏移通过 |
| P0-011 | 真实 ChatGPT WebMCP 验证 | P0-001～010 | 六工具真实可发现和调用 |
| P0-012 | 挑战赛预览部署 | P0-001～010 | 独立 URL 可访问 |
| P0-013 | 90 秒 Demo 录制 | P0-011/012 | 无剪贴板 JSON 墙，流程稳定 |
| P0-014 | Devpost 提交与最终冻结 | P0-013 | 提交页面完整 |
