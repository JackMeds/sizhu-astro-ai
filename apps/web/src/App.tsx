...
import { Braces, Cpu, LockKeyhole, PencilLine, Sparkles } from "lucide-react";
  ...
  return (
    <main className="app-shell workbench-v2">
      ...
      <header className="topbar">
        ...
        <nav><a href="#chart">命盘</a><a href="#export">AI 导出</a><a href="#mcp">Agent</a><ThemeToggle /></nav>
      </header>
      ...
      <section className="hero-workbench" id="top">
        <motion.div className="intro-copy intro-copy-v2" initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }}>
          <div>
            ...
            <p className="hero-description">同一份出生数据，由固定引擎生成八字、运限与紫微资料；时间口径、修正量、引擎和警告全部留痕。</p>
      ...
      <footer id="mcp" className="footer-strip">
        <div className="footer-copy"><strong>四柱星盘 AI · local-first deterministic chart engine</strong><span>开源仓库：<a href="https://github.com/JackMeds/sizhu-astro-ai" target="_blank" rel="noreferrer">JackMeds/sizhu-astro-ai</a></span><span>AI/Agent：<a href={agentGuideHref} target="_blank" rel="noreferrer">agents.md</a></span></div>
